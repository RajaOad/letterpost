...
export default function Mailbox({ onOpenLetter }) {
  ...
  return (
    <div className="space-y-6 md:space-y-8 w-full px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-nowrap justify-center md:justify-center gap-2 overflow-x-auto pb-2 scrollbar-hide pd-xy">
      ...
      {/* Letters Grid */}
      <div className="grid gap-4 md:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pb-8 pd-xy mr-b">
